        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$du['nama_user'];?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="../login.php?proses=logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php 
          @$p = $_GET['page'];
         ?>
        <li class="<?php if($p==""){echo "active";} ?>"><a href="index.php"><i class="fa fa-home"></i> <span>Home</span></a></li>
        <li class="<?php if($p=="kategori"){echo "active";} ?>"><a href="?page=kategori"><i class="fa fa-list-alt"></i> <span>Kategori</span></a></li>
