...
if($proses == 'add_keranjang'){
	...
	if($num==0){
		mysqli_query($koneksi, "INSERT INTO keranjang (id_user,id_barang,qty) VALUES (1, '$_POST[id_barang]','$_POST[qty]')");
	...
	$qker=mysqli_query($koneksi, "SELECT * FROM keranjang WHERE id_user = 1");
